...
require_once dirname(dirname(dirname(__DIR__))) . '/src/PropertyRenderer.php';

$properties = db()->query(
    "SELECT * FROM property_s WHERE cat_prop = '' ORDER BY sort_prop, id"
);
?>
            ...
            <section class="properties-panel">
                ...
                <div class="properties property_all" aria-live="polite">
                    <?php while ($property = $properties->fetch()): ?>
                        <?php echo renderProperty(db(), $property); ?>
                    <?php endwhile; ?>
                </div>
            </section>
        </div>
